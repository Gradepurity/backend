...
/**
 * Surgical add of a single GradePurity product (cjc-1295-ipamorelin) to the live
 ...
 */
const TARGET_SLUG = "cjc-1295-ipamorelin";
...
export default async function addCjcIpamorelin({
  container,
}: {
  ...
  logger.info("CJC-1295 + Ipamorelin toegevoegd aan live catalogus. ✅");
}
