...
/**
 * Surgical add of a single GradePurity product (sermorelin) to the live
...
export default async function addSermorelin({
  container,
}: {
  ...
  logger.info("Sermorelin toegevoegd aan live catalogus. ✅");
}
