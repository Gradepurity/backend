...
/**
 * Surgical add of a single GradePurity product (aod9604) to the live
...
export default async function addAod9604({
  container,
}: {
  ...
  logger.info("AOD9604 toegevoegd aan live catalogus. ✅");
}
