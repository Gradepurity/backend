...
/**
 * Surgical add of a single GradePurity product (kpv) to the live
...
export default async function addKpv({
  container,
}: {
  ...
  logger.info("KPV toegevoegd aan live catalogus. ✅");
}
